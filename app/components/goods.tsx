  ...
  return (
    <div className={styles.goods_wrap}>
        <Link href={`/goods/${props.id}`}>
            ...
            <p className={styles.tit}>{props.text}</p>
            {props.before ?<p className={styles.dimmed}>
                <span>{props.before}</span>원
            </p>:''}
            <div className={styles.price_area}>
                {props.per ?<p className={styles.per}>
                    <strong>{props.per}</strong>%
                </p> : ''}
                <p className={styles.real}>
                    <strong>{props.price}</strong>원
                </p>
            </div>
